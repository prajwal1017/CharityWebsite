...
namespace CharityWebSite.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductId,ProductName,Size,Color,Quantity")] Product product, HttpPostedFileBase upload)
        {
            try
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductId,ProductName,Size,Color,Quantity")] Product product)
        {
            if (ModelState.IsValid)
            {
